...
"crap","cunt","damn","handjob","hot ass","wet",
...
"Goddammit","hell","homo","jerk","cocaine","weed","smoke up","high","sleep with","holes",
...
if($num>=1){
	...
	$num1=(($num/str_word_count($data))*100)+rand(251, 259) / 10;
	echo $data;	
}
else if($num>=3)
{
