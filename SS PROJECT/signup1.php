...
<p><a href="MainPage.php">Go back</a></p>
    ...
    <form action="" method="post">
	    ...
	    <p>
			...
			<label for="pass">Password</label><input type="password" name="mypassword" id="txtPassword" class="w3-input w3-border" onkeyup="passwordStrength(this.value)" required="required"/><br />
			<label for="pass2">Confirm Password</label><input type="password" name="pass2" id="pass2" class="w3-input w3-border" required="required"/><br />
