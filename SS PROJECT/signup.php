...
<?php
      ...
      // username and password sent from form 
       // $fname = mysqli_real_escape_string($db,$_POST['fname']);
		...
		if($ans>=18){
		   ...
		   echo "<h1 style='color:red'>Oops! This username is already taken!</h1><p>please choose another one<p>    ";
   ...
   $error ="*email invalid";
		...
		else echo "<h1 style='color:red'>You are not old enough to be on this page!</h1>";
}
...
{	
        document.getElementById("password_strength").innerHTML = "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsplength less than 6";
...
function checkconf(conf)
{
	...
	if(pwd!=conf)
	{
		document.getElementById("confrm").innerHTML = "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp*passwords don't match";
...
<p><a href="MainPage.php">Go back</a></p>
    ...
    <form action="" method="post">
	    ...
	    <p>
			...
			<label>Email :</label><br /><input type = "text" name = "email" class="w3-input w3-border" id="em" pattern="^[a-zA-Z\._\-]+[0-9]*[a-zA-Z\._\-]+[0-9]*[@][a-zA-Z]+\.[a-zA-Z\.]{2,5}$" title="abc@example.com" required="required"/><br /><br />
